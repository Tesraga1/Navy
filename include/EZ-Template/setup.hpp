...
const int  L_CHASSIS_PORTS[MOTORS_PER_SIDE] = {18, -19, 1}; // Ports, the first number will be used for sensing
const int  R_CHASSIS_PORTS[MOTORS_PER_SIDE] = {14, -17, 2}; // Ports, the first number will be used for sensing
