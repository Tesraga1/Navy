...
/* To Do:
 * Auton 1: Win point (Probably not)
...
void skills_auton() {
    ...
    set_motors_drive(0);
    pros::delay(400);
    while (gyro.get_heading() < 85 || gyro.get_heading() > 87) {
    ...
    while (gyro.get_heading() < 135 || gyro.get_heading() > 137) {
        set_motors_left(6000);
    }
    set_motors_drive(0);
    pros::delay(20);
    ...
    set_motors_drive(0);
    pros::delay(300);
    while (gyro.get_heading() < 299 || gyro.get_heading() > 305) {
        set_motors_left(6000);
    }
    set_motors_drive(-6000);
     pros::delay(550);
     ...
     pros::delay(1600);
     set_lift(0);
     while (gyro.get_heading() < 111 || gyro.get_heading() > 118) {
        set_motors_left(6000);
    }
     set_motors_drive(-6000);
     pros::delay(1150);
    ...
    pros::delay(500);
    set_motors_drive(6000);
    pros::delay(1150); //pros::delay(950);
    set_motors_drive(0);
    ...
    set_motors_drive(0);
    pros::delay(300);
    while (gyro.get_heading() < 184 || gyro.get_heading() > 189) {
        set_motors_right(6000);
    }
    set_motors_drive(0);
    pros::delay(20);
